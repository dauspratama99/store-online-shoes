<table width="100%" border="0" cellpadding="4" cellspacing="0">
  ...
  ?>
    <form name="frmLogin" method="post" action="?open=Login-Validasi">
      <tr>
        <td height="22" align="center" bgcolor="#696969" class="head"><b>
            <font color="white">
              <font face="Comic Sans">LOGIN </font>
          </b></td>
        </font>
      </tr>
      <tr>
        <td width="919" height="18"><b>
            <font color="black">
              <font face="Comic Sans">Username : </font>
          </b><br /></font>
      ...
      <tr>
        <td height="18"> <b>
            <font color="black">
              <font face="Comic Sans">Password :</font>
          </b> <br /></font>
      ...
      <tr>
        <td><b><img src="images/ikon.jpg" width="9" height="9">
            <a href="?open=Pelanggan-Baru" target="_self">
              <font color="black">
                <font face="Comic Sans">Register </font>
            </a></b></td>
        </font>
      </tr>
      <tr>
  ...
  ?>
    <tr>
      <td height="22" align="center" bgcolor="#d07831" class="head"><b>
          <font face="Comic Sans">TRANSAKSI
        </b></td>
      </font>
    </tr>
    <tr>
    ...
    <tr>
      <td><b> <img src="images/ikon.jpg" width="9" height="9"> <a href="?open=Konfirmasi" target="_blank">Konfirmasi Pembayaran </a> </b></td>
    </tr>
    <tr>
