...
<body topmargin="3">
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="black" class="border">
    <tr bgcolor="#696969">
      <td height="24" align="right" bgcolor="#696969">
        <font color="black"><?php include "inc.login_status.php"; ?></font>
      </td>
    </tr>
    <tr>
    ...
    <td height="30" colspan="3" bordercolor="#778899" bgcolor="#696969" class="HEAD" size="14">
      <script language="JavaScript">
        ...
        <div 0px="" 12px="" arial="" color:="" ff0000="" font:="" id="textDestination" margin:="" style="background-color: blue;"></div>
      </b>
      <script language="JavaScript">
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr bgcolor="#696969" class="header">
      ...
      <td width="98" align="center" bgcolor="#696969"><a href="?open=Home" target="_self">
          <font color="white"><b>
              <font face="Comic Sans">HOME
            </b></font>
        </a></td>
      </font>
      <td width="98" align="center" bgcolor="#696969"><a href="?open=Profil" target="_self">
          <font color="white"><b>
              <font face="Comic Sans">PROFIL
            </b></font>
        </a></td>
      </font>
      <td width="150" align="center" bgcolor="#696969"><a href="?open=Barang" target="_self">
          <font color="white"><b>
              <font face="Comic Sans">KOLEKSI BARANG
            </b></font>
        </a></td>
      </font>
      <!--
	...
	-->
      <td width="101" align="center" bgcolor="#696969"><a href="user/index.php" target="_self">
          <font color="white"><b>
              <font face="Comic Sans">USER
            </b></font>
        </a></td>
      </font>
      <td width="101" align="center" bgcolor="#696969"><a href="admin/index.php?open=Login" target="_self">
          <font color="white"><b>
              <font face="Comic Sans">ADMIN
            </b></font>
        </a></td>
      </font>
    </tr>
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="22" colspan="3" align="right" bgcolor="#696969" class="head">
        <form action="?open=Barang-Pencarian" method="post" name="form1">
          <strong>
            <font color="white">
              <font face="Comic Sans">Cari Barang</font>
          </strong></font>
    ...
    <tr>
      <td align="center" valign="top" bgcolor="#FAFAD2" class="utama">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="0">
          ...
          <tr align="center">
            <td width="167" height="22" bgcolor="#696969" class="head">
              <font color="black"><b>
                  <font face="Comic Sans">KATEGORI
                </b></font>
            </td>
            </font>
          </tr>
    ...
    <tr>
      <td height="50" colspan="3" align="center" bgcolor="#696969" class="FOOT">
        <font color="white">Copyright© | YOUTHLAND STORE</font>
      </td>
    </tr>
  </table>
</body>
